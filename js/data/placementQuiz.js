...
APP_DATA.placementQuiz = {
  ...
  questions: [
    ...
    { level: 'a1', q: 'Choose the correct greeting for the morning.', options: ['Good night', 'Good morning', 'Good evening', 'Goodbye'], answer: 1 },
    { level: 'a1', q: 'Complete the question: "___ you a teacher?"', options: ['Am', 'Is', 'Are', 'Be'], answer: 2 },
    ...
    { level: 'a2', q: 'Choose the correct continuous form: "She ___ dinner right now."', options: ['cook', 'cooks', 'is cooking', 'cooked'], answer: 2 },
    { level: 'a2', q: 'Complete: "There ___ many people at the party last night."', options: ['was', 'were', 'is', 'are'], answer: 1 },
    ...
    { level: 'b1', q: 'Choose the best sentence for a spontaneous decision made right now.', options: ['I will help you with that.', 'I am going to help you with that tomorrow.', 'I help you with that.', 'I helped you with that.'], answer: 0 },
    { level: 'b1', q: 'Which phrasal verb means "to postpone"?', options: ['give up', 'put off', 'look forward to', 'get along'], answer: 1 },
    ...
    { level: 'b2', q: 'Choose the correct third conditional.', options: ['If I studied more, I would pass.', 'If I had studied more, I would have passed.', 'If I study more, I will pass.', 'If I would study more, I passed.'], answer: 1 },
    { level: 'b2', q: 'Choose the correct passive form for: "They are building a new bridge."', options: ['A new bridge is built.', 'A new bridge is being built.', 'A new bridge was being built.', 'A new bridge builds.'], answer: 1 },
    ...
    { level: 'c1', q: 'Choose the sentence with correct inversion for emphasis.', options: ['Never I have seen such a mess.', 'Never have I seen such a mess.', 'I have never seen such a mess not.', 'Never did I saw such a mess.'], answer: 1 },
    { level: 'c1', q: 'Choose the most natural collocation.', options: ['make a decision', 'do a decision', 'take a decision', 'have a decision'], answer: 0 },
    ...
    { level: 'c2', q: 'Choose the most appropriate register for a formal business email opening.', options: ['Hey! What\'s up?', 'I am writing to inquire about...', 'Yo, quick question...', 'Sup, need to ask something.'], answer: 1 },
    { level: 'c2', q: 'Which sentence best uses a rhetorical question for effect?', options: ['What time is the meeting?', 'Isn\'t it obvious what we should do?', 'Where did you put the keys?', 'How much does this cost?'], answer: 1 }
  ],
